# ref https://github.com/apache/beam/blob/master/sdks/python/apache_beam/examples/cookbook/bigquery_schema.py
#
...
def run(argv=None):
    ...
    with beam.Pipeline(argv=pipeline_args) as p:
        from apache_beam.io.gcp.internal.clients import \
            bigquery  # pylint: disable=wrong-import-order, wrong-import-position
